...
export const Search = () => {
    ...
    return (
        <>
            <div className='searchPage bg-[#f2f4f5]'>
                    ...
                    <div className="search-input text-center mt-[60px]">
                        <div class="input-group mb-3 m-auto max-w-[1200px]">
                            <Input type="text"
                                    ...
                                    className='w-[1200px] rounded-lg h-[60px] border-black box-border pl-[20px]'/>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            return (
                                <div class="p-4 md:w-1/3">
                                    <div class="h-full border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden">
                                        <img class="lg:h-48 md:h-36 w-full object-cover object-center" src={product.imgUrl} alt="blog" />
                                        <div class="p-6">
                                            <h2 class="tracking-widest text-xs title-font font-medium text-gray-400 mb-1">CATEGORY</h2>
                                            <h1 class="title-font text-lg font-medium text-gray-900 mb-3">{product.name}</h1>
                                            <p class="leading-relaxed mb-3">{product.desc}</p>
